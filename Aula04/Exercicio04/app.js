...
*/
const my3FavoriteTVShows = ["Shrek", "Os Vingadores", "Avatar"]
const sentence = "Minhas 3 filmes favoritos são: (my3FavoriteTVShows[]), (my3FavoriteTVShows[1]) e (my3FavoriteTVShows[2])."
print(sentence)
...
var possuiTresItens = series.length === 3;

console.log(possuiTresItens);
...
const isRandomTVShowIncluded = series.includes(randomTVShow);
...
*/
let numChar = 39;
console.log(`a string que a "typeSetence" armazena tem mais de ${numChar}`)
...
// Agora, vou exibir a frase solicitada, substituindo os espaços reservados pelos valores corretos.
...
//A conversão de crazyOperation para booleano resulta em true porque qualquer valor diferente de zero é considerado verdadeiro em javascript
...
const isSumLessOrEqual92 = agesSum <= 92;

console.log("A soma entre o 1º e o 3º item de 'ages' é menor ou igual a 92. Essa afirmação é: " + isSumLessOrEqual92);
